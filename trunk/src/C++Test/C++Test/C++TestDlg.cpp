...
#include "../../../include/Algorithm_CSharp/Algorithm.h"


#ifdef DEBUG 

#pragma comment(lib, "../../../lib/Algorithm_CSharpd.lib")
#pragma  message(".......................................当前为debug版本")

#else

#pragma comment(lib, "../../lib/Algorithm_CSharp.lib")
...
CCTestDlg::CCTestDlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(CCTestDlg::IDD, pParent)
{
...
BEGIN_MESSAGE_MAP(CCTestDlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
...
void CCTestDlg::OnBnClickedOk()
{
	...
	file.Open("E:\\新雕刻机\\trunk\\bin\\unseodata.xml", CFile::modeRead);

	int file_len = file.GetLength();
	char* file_content = new char[file_len+1];

	file.Read(file_content, file_len);

	
	CString str = LayoutOptimizeByStream(file_content);
